 ...
 * 
 */
public class Task1 extends Thread { //thie is how java implements threads 
    ...
    @Override
    public void run() { //gets callwed when strt runs on this object
        ...
        for (int i = 0; i < maxValue; i++) {
            ...
            if (exit) {
                return;//add notification and manage states
            }
        }
        doNotify("Task1 done.");
    }
